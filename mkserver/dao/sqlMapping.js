var sqlmap = {
  ...
  getvisitorplan: 'select b.Store_name,e.City_lev,b.Gps_x,b.Gps_y,c.realname,d.path_name,a.* from plan a LEFT JOIN store b ON (a.store_id = b.Store_id) LEFT JOIN user c ON (a.userid = c.username) LEFT JOIN path d ON (a.path_id = d.path_id) LEFT JOIN city e ON (e.City_id = b.City_id) where (userid like ? or realname like ?) and plan_date BETWEEN ? and ? order by a.signin_time desc',
  ...
  getvisitormainshelf: 'select b.Store_name,c.realname,d.product_name,a.* from visitor_shelfmain a LEFT JOIN store b ON (a.store_id = b.Store_id) LEFT JOIN user c ON (a.user_id = c.username) left join product d on a.product_id = d.product_id where (a.user_id like ? or realname like ?) and a.plan_date BETWEEN ? and ? order by a.plan_date desc,a.store_id',
  getvisitorstock: 'select b.Store_name,c.realname,d.product_name,a.* from visitor_stock a LEFT JOIN store b ON (a.store_id = b.Store_id) LEFT JOIN user c ON (a.user_id = c.username) left join product d on a.product_id = d.product_id where (a.user_id like ? or realname like ?) and a.plan_date BETWEEN ? and ? order by a.plan_date desc,a.store_id',
  getvisitorshelfaway: 'select b.Store_name,c.realname,d.product_name,a.* from visitor_shelfaway a LEFT JOIN store b ON (a.store_id = b.Store_id) LEFT JOIN user c ON (a.user_id = c.username) left join product d on a.product_id = d.product_id where (a.user_id like ? or realname like ?) and a.plan_date BETWEEN ? and ? order by a.plan_date desc,a.store_id,a.display_id',
