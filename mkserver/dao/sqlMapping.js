var sqlmap = {
  ...
  adduser: 'insert into user(username,password,realname,phone,email,depart) values(?,?,?,?,?,?)',
  moduser: 'update user set username = ? , password = ?, realname = ?, phone = ?, email = ?, depart = ? where id = ?',
