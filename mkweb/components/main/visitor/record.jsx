...
import { Table, Select, Tabs, Button, Icon, Modal, Tag, Input, Tree, Popconfirm, message, DatePicker, Breadcrumb } from 'antd';
    ...
    return (
      <div className={styles.visitorcontent}>
        ...
        <div className={styles.queryContainer}>
          <Select onChange={this.onTextChange} placeholder="请选择销售代表" style={{ width: 120, marginRight: '20px' }}>
            {this.getUserOption()}
          </Select>
